---
name: opal-scripting
description: Use when writing, editing, or debugging Opal Minecraft client scripts (the .js files under opal/scripts) — covers the registerScript / module / settings / event model, the renderer canvas and color rule, palette command-palette views, dynamic islands, notifications, and the full-trust security model.
---
